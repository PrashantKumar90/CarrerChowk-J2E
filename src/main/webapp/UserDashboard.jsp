			...
			<div class="col-lg-4 col-md-6">
				<div class="card">
					<div class="card-body">
						...
						<h5 class="card-title">View Applied Job</h5>
			...
			<div class="col-lg-4 col-md-6">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Explore New Jobs and Opportunities</p>
						<form action="<%=request.getContextPath()%>/JobList">
							<button type="submit" class="btn btn-card">
								Add Jobs <i class="fas fa-briefcase ms-2"></i>
							</button>
						</form>
					</div>
				</div>

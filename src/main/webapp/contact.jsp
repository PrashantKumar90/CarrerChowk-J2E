...
<head>
<meta charset="utf-8">
<title>Fuel Your Future with ScholarshipInfo</title>
				...
				<div class="row g-4">
						...
						<div class="row gy-4">
							<div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
								<div class="d-flex align-items-center bg-light rounded p-4">
									...
									<span>Address: A-1, Padmawati Colony-B, Nirman Nagar,
										Jaipur, Rajasthan 303121</span>
								</div>
							</div>
							<div class="col-md-4 wow fadeIn" data-wow-delay="0.3s">
								<div class="d-flex align-items-center bg-light rounded p-4">
									...
									<span>info@ScholarshipInfo.com</span>
								</div>
							</div>
					...
					<div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
						<iframe class="position-relative rounded w-100 h-100"
							src="https://www.google.com/maps/embed?pb=..." frameborder="0"
